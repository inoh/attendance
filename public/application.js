...
global.Vue = require("./../../../bower_components/vue/dist/vue.js");

global.VueRouter = require("./../../../bower_components/vue-router/dist/vue-router.js");

Vue.use(VueRouter);

Vue.use(require("./../../../bower_components/vue-validator/dist/vue-validator"));

global.moment = require("./../../../bower_components/moment/moment.js");

global.$ = global.jQuery = require("./../../../bower_components/jquery/dist/jquery.js");
...
$(function() {
  var map;
  console.log(require("./pages/works/index"));
  map = {
    '/works': {
  ...
  router.map(map);
  return router.start(App, '#app-main');
});


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./../../../bower_components/jquery/dist/jquery.js":3,"./../../../bower_components/moment/moment.js":4,"./../../../bower_components/vue-router/dist/vue-router.js":5,"./../../../bower_components/vue-validator/dist/vue-validator":6,"./../../../bower_components/vue/dist/vue.js":7,"./pages/works/index":2}],2:[function(require,module,exports){
({
  data: function() {
    return {
      year: moment().year(),
  ...
  methods: {
    next: function() {
      var next;
      next = this.toMoment().add(1, 'months');
      this.year = next.year();
      return this.month = next.month() + 1;
    },
    prev: function() {
      var prev;
      prev = this.toMoment().add(-1, 'months');
      this.year = prev.year();
      return this.month = prev.month() + 1;
    },
    dates: function() {
      var cur, endDate, endPosition, result, startPosition;
      cur = this.toMoment().startOf('month');
      startPosition = cur.day() === 0 ? 6 : cur.day() - 1;
      cur.subtract(startPosition, 'days');
      endDate = this.toMoment().endOf('month');
      endPosition = endDate.day() === 0 ? 0 : 7 - endDate.day();
    ...
    toMoment: function() {
      return moment(this.year + "/" + this.month + "/1", 'YYYY/M/D');
    }
  }
});
